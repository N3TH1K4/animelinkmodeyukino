...
whiskera=[Button.url('A Whisker Away','https://t.me/Whisker_Away')]
afterrain=[Button.url('After The Rain','https://t.me/After_The_Rain_Series')]
ahiruno=[Button.url('Ahiru No Sora','http://t.me/Ahiru_No_Sora_Series')]
ajin=[Button.url('Ajin','https://t.me/AjinDemiHuman')]
akame=[Button.url('Akame Ga Kill','http://t.me/Akame_Ga_Kill_Dual')]
akira=[Button.url('Akira','https://t.me/Akira_AnimeMovie')]
akudama=[Button.url('Akudama Drive','http://t.me/Akudama_Drive_Series')]
angel=[Button.url('Angel Beats','https://t.me/Angel_Beats_Series')]
...
gray=[Button.url('D.Gray-man','https://t.me/D_Gray_Man_Series')]
dan=[Button.url('Danganronpa','https://t.me/Danganronpa_Series')]
danma=[Button.url('DanMachi','https://t.me/Danmachi_Anime')]
dtb=[Button.url('Darker than BLACK ','http://t.me/Darker_than_BLACK_Series')]
darling=[Button.url('DARLING in the FRANXX','https://t.me/Darling_in_the_FranXX_Dual')]
darwin=[Button.url("Darwin's Game",'https://t.me/Darwins_Game_Series')]
dal=[Button.url('Date a Live ','http://t.me/DateA_Live')]
dn=[Button.url('Death Note','https://t.me/Death_Note_Dual')]
dp=[Button.url('Death Parade','https://t.me/Death_Parade_Dual')]
dd=[Button.url('Deca-Dence','http://t.me/DecaDence_Dual')]
ds=[Button.url('Demon Slayer: Kimetsu No Yaiba','http://t.me/Demon_Slayer_Dual')]
denn=[Button.url('Dennou Coil : Den-noh Coil','http://t.me/Dennou_Coil_Series')]
dc=[Button.url('Detective Conan: Case Closed','http://t.me/detective_conan_sub')]
dmc=[Button.url('Detroit Metal City','https://t.me/Detroit_Metal_City')]
dmcb=[Button.url('Devilman: Crybaby','https://t.me/Devilman_Dual')]
domes=[Button.url('Domestic Girlfriend','https://t.me/Domestic_Girlfriend_Dual')]
nagato=[Button.url("Don't Toy With Me Nagatoro san",'http://t.me/Ijiranaide_Nagatoro_San_Series')]
dorohe=[Button.url('Dorohedoro','http://t.me/Dorohedoro_Series')]
dororo=[Button.url('Dororo','https://t.me/Dororo_Series')]
drgb=[Button.url('Dragon Ball(Collection)','https://t.me/Dragon_Ball_Collections/235')]
